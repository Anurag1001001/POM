...
Router.get("/matches", controller.getData);
Router.get("/matches/likes", controller.getData);
Router.get("/matches/profile/:id", controller.getData);
Router.get("/profile/:id/unmatch", controller.getData);
Router.get("/matches/profile/:id/like", controller.getData);
Router.get("/matches/profile/:id/dislike", controller.getData);
...
Router.post("/chat/image", controller.postData);
Router.post("/event", controller.postData);
Router.post("/user/image", controller.postData);
...
Router.post("/reports/new", controller.postData);
...
Router.delete("/user/image/:uuid", controller.deleteData);
